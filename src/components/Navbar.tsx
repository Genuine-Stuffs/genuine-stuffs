...
const Navbar = () => {
  ...
  return (
    <nav className={`${isActive("/pros") ? "relative" : "sticky top-0"} z-50 bg-white/80 dark:bg-slate-700/80 backdrop-blur-xl border-b border-slate-100 dark:border-border transition-colors duration-300`}>
