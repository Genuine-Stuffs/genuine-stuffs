                ...
                <div className="grid grid-cols-12 gap-6 md:gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8 space-y-6 md:space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
                            <Card className="rounded-[2.5rem] border border-slate-200/50 dark:border-red-500/30 bg-white/70 dark:bg-[#0F1115]/60 backdrop-blur-xl shadow-xl dark:shadow-[0_0_15px_-5px_rgba(59,130,246,0.3)] overflow-hidden group">
                             ...
                             <Card className="rounded-[2.5rem] border border-slate-200/50 dark:border-red-500/30 bg-slate-900 dark:bg-[#0F1115]/60 backdrop-blur-xl shadow-2xl dark:shadow-[0_0_20px_-5px_rgba(59,130,246,0.4)] overflow-hidden group">
                                <CardContent className="p-6 md:p-8">
                                    <div className="flex justify-between items-start mb-6">
                        ...
                        <Card className="rounded-[2.5rem] border border-slate-200/50 dark:border-red-500/30 bg-white/70 dark:bg-[#0F1115]/60 backdrop-blur-3xl shadow-2xl dark:shadow-[0_0_25px_-10px_rgba(59,130,246,0.3)] overflow-hidden">
                    ...
                    <div className="col-span-12 lg:col-span-4 space-y-8">
                        ...
                        <Card className="rounded-[3rem] border-none bg-primary text-white p-1 shadow-2xl dark:shadow-[0_0_30px_-10px_rgba(59,130,246,0.5)] relative overflow-hidden group">
                           ...
                           <CardContent className="bg-slate-900 dark:bg-[#0F1115] rounded-[2.8rem] p-10 h-full relative z-10 border dark:border-red-500/30">
                        ...
                        <Card className="rounded-[3rem] border border-slate-200/50 dark:border-red-500/30 bg-white/70 dark:bg-[#0F1115]/60 backdrop-blur-xl shadow-xl dark:shadow-[0_0_20px_-5px_rgba(59,130,246,0.3)] overflow-hidden p-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                <Link 
                                    key={i} 
                                    to={tool.path}
                                    className="p-6 bg-white dark:bg-[#0F1115] rounded-[2rem] border border-slate-200/50 dark:border-red-500/30 shadow-lg dark:shadow-[0_0_15px_-5px_rgba(59,130,246,0.3)] hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 flex flex-col items-center text-center group"
                                >
